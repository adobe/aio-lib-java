 ...
 */
package com.adobe.workspace.ocd;
...
public @interface WorkspaceConfig {
  ...
  @AttributeDefinition(name = "Meta Scopes",
      description = "List of metascopes associated with your API (default to /s/event_receiver_api , /s/ent_adobeio_sd) (project.workspace.details.credentials.jwt.meta_scopes)",
      cardinality = 10)
  String[] aio_meta_scopes() default {"/s/event_receiver_api", "/s/ent_adobeio_sdk"};
  ...
  String aio_client_secret() default "";
  ...
  String aio_credential_id() default "";
  ...
  String aio_consumer_org_id() default "";
  ...
  String aio_workspace_id() default "";
