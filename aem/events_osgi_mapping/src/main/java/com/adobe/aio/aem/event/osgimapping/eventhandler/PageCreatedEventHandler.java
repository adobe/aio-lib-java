...
public class PageCreatedEventHandler extends PageModificationEventHandler {

  public PageCreatedEventHandler(JobManager jobManager, URL rootUrl, String imsOrgId,
      OsgiEventMapping osgiEventMapping,
      ResourceResolverWrapper resourceResolverWrapper) {
    super(ModificationType.CREATED, jobManager, rootUrl, imsOrgId,
