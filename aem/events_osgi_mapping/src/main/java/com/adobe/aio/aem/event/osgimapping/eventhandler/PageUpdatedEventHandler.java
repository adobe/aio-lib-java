...
public class PageUpdatedEventHandler extends PageModificationEventHandler {

  public PageUpdatedEventHandler(JobManager jobManager, URL rootUrl, String imsOrgId,
      OsgiEventMapping osgiEventMapping,
      ResourceResolverWrapperFactory resourceResolverWrapperFactory) {
    super(ModificationType.MODIFIED, jobManager, rootUrl, imsOrgId,
