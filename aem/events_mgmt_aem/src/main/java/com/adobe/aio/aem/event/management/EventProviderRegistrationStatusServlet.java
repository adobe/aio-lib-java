...
@SlingServletPaths("/bin/aio/events/provider.json")
public class EventProviderRegistrationStatusServlet extends StatusServlet {
  ...
  public Status getStatus() {
    return eventProviderRegistrationService.getStatus();
  }
}
